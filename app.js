...
(() => {
  ...
  const els = Object.fromEntries([
    ...
    'copyLinkBtn','startGameBtn','endGameBtn','waitingText','roundLabel','questionCounter',
  ...
  function routeRoom(prev,room){
    if(room.phase==='ended'){
      ...
      els.correctAnswerLabel.textContent='🛑 La partie a été arrêtée par l\'organisateur.';
      els.questionRanking.innerHTML='';
      return;
    }
  ...
  function renderLobby(){
    ...
    els.endGameBtn.classList.toggle('hidden',!state.isHost);
  ...
  async function endGame(){
    ...
    await patchRoom({phase:'ended',endedAt:Date.now()});
  }
